...
/*   Updated: 2024/11/25 16:08:23 by junhhong         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// int main()
// {
// 	int fd9 = open("9.txt", O_RDONLY);
// 	int fd9n = open("9n.txt", O_RDONLY);
// 	int fd10 = open("10.txt", O_RDONLY);
// 	int fd10n = open("10n.txt", O_RDONLY);
// 	//fd = 50;
// 	printf("	shouldbe:123456789, ANS::%s\n",get_next_line(fd9));
// 	printf("	shouldbe:123456789n, ANS::%s\n",get_next_line(fd9n));
// 	printf("	shouldbe:1234567890, ANS::%s\n",get_next_line(fd10));
// 	printf("	shouldbe:1234567890n, ANS::%s\n",get_next_line(fd10n));
// 	// printf("FINAL::%s\n",get_next_line(fd));
// 	// printf("FINAL::%s\n",get_next_line(fd));
// 	// printf("FINAL::%s\n",get_next_line(fd));
// }
